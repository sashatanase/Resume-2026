...
- Coordinated cross-functional teams across Product, Design, Engineering, and Marketing, and built a centralized insight repository used across the company. The repository became the single source of truth for research, supporting 15+ stakeholders, reducing duplicate research efforts by approximately 30%, and accelerating decision-making across teams.

- Guided product teams with actionable insights that shaped roadmap sequencing and scope. Research inputs informed over 60% of roadmap decisions related to onboarding, borrowing flows, and user education, shortening validation cycles and reducing misaligned initiatives by roughly 25%.
...
- Led end-to-end product discovery and delivery for the Threshold Network Dashboard, covering onboarding, legacy stake migration, new staker flows, and Node Operator experiences. Ran extensive research with stakers, node operators, service providers, and BTC-focused DeFi users. Research-driven iterations improved onboarding completion by approximately 25% and reduced time-to-first-stake by around 20%.
...
- Improved the tBTC Node Operator experience by redesigning client-code UX and documentation. Created a custom research methodology combining diary studies and interviews to evaluate real-world setup and maintenance workflows, reducing setup-related issues by approximately 30% and improving operator-reported clarity.
